...
echo form_open("admin/update_applicant_details");?>
...
<input class=button type="reset" name="cancel" value="Cancel" onclick="window.location = '<?php echo base_url("admin/view_applicant_details/".$this->session->userdata("exam_id"));?>'" />
</form>
</div>
